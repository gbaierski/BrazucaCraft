...
<body style="background-image: url('../../assets/img/paginas/telaManutencao.jpg')">
    <div style="color:white; text-align:center; font-size:2vw; padding-top:15vw; font-family:monospace; font-weight: 700;"> Por favor, digite a senha para o acesso:</div>
    <form action="" method="POST">
        ...
        <br>
        <input type="submit" value="Enviar" style= "background-color: rgb(22, 163, 69); border-left: none; border-top: none; font-weight: 700; font-family: monospace; color: white; cursor: pointer; margin-left:45%; width: 10%; height:3vw; margin-top:1vw; border-bottom: 0.2vw solid rgba(10, 10, 10, 0.4); border-right: 0.2vw solid rgba(10, 10, 10, 0.4); text-shadow: 0.08vw 0.10vw rgba(0, 0, 0, 0.651); font-size: 1.6vw;">
