    ...
    <div id="div-cadastroProduto">
        <h2 id="cadastroProduto-titulo"><?= $nomeForm ?></h2>
                ...
                <form action="<?= $nomeForm == 'Cadastro de Produto' ? '..\control\produtos.php?action=cadastroProduto' : '..\control\produtos.php?action=editarProduto&ai_produto='. $produtos['ai_produto']?>" enctype="multipart/form-data" method="post" id="form-cadastroProdutos">
                    ...
                    <input  value="<?= isset($produtos['nomeProduto']) ? $produtos['nomeProduto'] : ''?>" type="text" name="nomeProduto"  class="cadastroProduto" id="nomeProduto" pattern="[a-zA-Z0-9]+" required>
                    ...
                    <textarea value="<?= isset($produtos['descricaoProduto']) ? $produtos['descricaoProduto'] : ''?>" name="descricaoProduto" class="cadastroProduto" id="descricaoProduto" rows="5" pattern="[a-zA-Z0-9]+" required><?= isset($produtos['descricaoProduto']) ? $produtos['descricaoProduto'] : '' ?></textarea>
